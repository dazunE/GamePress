<?php
/**
 * gamepress functions and definitions
 *
 * @package gamepress
 */
...
function gamepress_setup() {
	 ...
	 * If you're building a theme based on gamepress, use a find and replace
	 * to change 'gamepress' to the name of your theme in all the template files
	 */
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'gamepress' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'gamepress_custom_background_args', array(
		'default-color' => 'ffffff',
		'default-image' => '',
	) ) );
}
endif; // gamepress_setup
 ...
 */
function gamepress_widgets_init() {
	register_sidebar( array(
		'name'          => __( 'Sidebar', 'gamepress' ),
		'id'            => 'sidebar-1',
		'description'   => '',
...
add_action( 'widgets_init', 'gamepress_widgets_init' );
...
function gamepress_scripts() {
	...
	wp_enqueue_script('bootstrap' , get_template_directory_uri() . '/js/bootstrap.js', array('jquery'), '20161007', true);
	...
	wp_enqueue_script( 'chart-js' , get_template_directory_uri(). '/node_modules/chart.js/dist/Chart.js' , array(), '20161006', true);

	wp_enqueue_script( 'custom-script', get_template_directory_uri() . '/js/script.js', array(), '20161006', true );
